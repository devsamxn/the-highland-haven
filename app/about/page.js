  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Highland Haven has been a cherished family-run
          ...
          <p>
            Over the years, we&apos;ve maintained the essence of The Highland
            ...
            us at The Highland Haven soon, where tradition meets tranquility,
